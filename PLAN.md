...
- [x] **Card 09 — Source: ONNX/Essentia**
...
- [x] **Card 13 — Rate limiting + backoff**
...
- [x] **Card 14 — Tokio + Rayon bridge**
  rayon::par_iter() sobre Vec<PathBuf> para CPU (audio, voting).
  Dentro de cada rayon thread: tokio::runtime::Builder::new_current_thread().block_on(pipeline).
  Arc<RateLimiter> y Arc<CachePool> compartidos entre todos los threads.

- [x] **Card 15 — Integration tests**
  tests/integration_test.rs: 7 tests — decade, vote (4 casos), conflict resolution.
